...
> The CIM compute datapath is synthesizable, simulation-verified, and hardened: `cim_mac_controller.v`, a pipelined 8×8 INT8 systolic MAC array (64 PEs, C = A×B), verified with iverilog (512 checks, 0 errors) and hardened standalone on Sky130 — **53,120 cells, 1.36 mm² @ 44.8% util, DRC/LVS-clean, meeting 100 MHz at the typical corner** (slow-corner ~84 MHz; 39 residual antenna violations).
